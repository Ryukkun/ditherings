 ...
 */
        ...
        *((short *) ( /* dim=0 */ (__pyx_v_diffe.data + __pyx_t_23 * __pyx_v_diffe.strides[0]) )) = ((*((short *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_target_copy.data + __pyx_t_21 * __pyx_v_target_copy.strides[0]) ) + __pyx_t_20 * __pyx_v_target_copy.strides[1]) ) + __pyx_t_19 * __pyx_v_target_copy.strides[2]) ))) - (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_colors.data + __pyx_t_18 * __pyx_v_colors.strides[0]) ) + __pyx_t_17 * __pyx_v_colors.strides[1]) ))));
 ...
 * 
 */
        __pyx_t_17 = __pyx_v_color_index;
        __pyx_t_18 = __pyx_v_iiii;
        __pyx_t_19 = __pyx_v_i;
        __pyx_t_20 = __pyx_v_ii;
        __pyx_t_21 = __pyx_v_iiii;
        *__Pyx_BufPtrStrided3d(unsigned char *, __pyx_pybuffernd_target.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_target.diminfo[0].strides, __pyx_t_20, __pyx_pybuffernd_target.diminfo[1].strides, __pyx_t_21, __pyx_pybuffernd_target.diminfo[2].strides) = (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_colors.data + __pyx_t_17 * __pyx_v_colors.strides[0]) ) + __pyx_t_18 * __pyx_v_colors.strides[1]) )));
      }
 ...
 */
          ...
          __pyx_t_21 = __pyx_v_nii;
          __pyx_t_20 = __pyx_v_iii;
          *((short *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_target_copy.data + __pyx_t_17 * __pyx_v_target_copy.strides[0]) ) + __pyx_t_21 * __pyx_v_target_copy.strides[1]) ) + __pyx_t_20 * __pyx_v_target_copy.strides[2]) )) += ((short)((*((short *) ( /* dim=0 */ (__pyx_v_diffe.data + __pyx_t_18 * __pyx_v_diffe.strides[0]) ))) * 0.4375));
        }
 ...
 */
            __pyx_t_18 = __pyx_v_iii;
            __pyx_t_20 = __pyx_v_ni;
            __pyx_t_21 = __pyx_v_nii;
            __pyx_t_17 = __pyx_v_iii;
            *((short *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_target_copy.data + __pyx_t_20 * __pyx_v_target_copy.strides[0]) ) + __pyx_t_21 * __pyx_v_target_copy.strides[1]) ) + __pyx_t_17 * __pyx_v_target_copy.strides[2]) )) += ((short)((*((short *) ( /* dim=0 */ (__pyx_v_diffe.data + __pyx_t_18 * __pyx_v_diffe.strides[0]) ))) * 0.0625));
          }
 ...
 */
          ...
          __pyx_t_20 = __pyx_v_iii;
          *((short *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_target_copy.data + __pyx_t_17 * __pyx_v_target_copy.strides[0]) ) + __pyx_t_21 * __pyx_v_target_copy.strides[1]) ) + __pyx_t_20 * __pyx_v_target_copy.strides[2]) )) += ((short)((*((short *) ( /* dim=0 */ (__pyx_v_diffe.data + __pyx_t_18 * __pyx_v_diffe.strides[0]) ))) * 0.3125));
        }
 ...
 */
            __pyx_t_18 = __pyx_v_iii;
            __pyx_t_20 = __pyx_v_ni;
            __pyx_t_21 = __pyx_v_nni;
            __pyx_t_17 = __pyx_v_iii;
            *((short *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_target_copy.data + __pyx_t_20 * __pyx_v_target_copy.strides[0]) ) + __pyx_t_21 * __pyx_v_target_copy.strides[1]) ) + __pyx_t_17 * __pyx_v_target_copy.strides[2]) )) += ((short)((*((short *) ( /* dim=0 */ (__pyx_v_diffe.data + __pyx_t_18 * __pyx_v_diffe.strides[0]) ))) * 0.1865));
          }
